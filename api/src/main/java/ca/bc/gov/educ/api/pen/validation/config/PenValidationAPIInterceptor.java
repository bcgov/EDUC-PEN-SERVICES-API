 ...
 */
@Component
public class PenValidationAPIInterceptor extends HandlerInterceptorAdapter {

  /**
   * The constant log.
   */
  private static final Logger log = LoggerFactory.getLogger(PenValidationAPIInterceptor.class);
