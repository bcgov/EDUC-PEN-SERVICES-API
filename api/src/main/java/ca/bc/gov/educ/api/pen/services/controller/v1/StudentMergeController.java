...
public class StudentMergeController implements StudentMergeEndpoint {
  ...
  @Override
  public List<StudentMerge> findStudentMergesBetweenDatesCreated(final String createDateStart, final String createDateEnd, final String mergeDirectionCode) {
  ...
  @Override
  public ResponseEntity<Object> deleteMerge(final UUID studentMergeID) {
    return this.getService().findStudentMergeByID(studentMergeID).map(studentMergeEntity -> {
      this.getService().deleteStudentMerge(studentMergeEntity);
