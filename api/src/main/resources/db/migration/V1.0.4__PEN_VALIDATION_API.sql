...
LOB (PAYLOAD) STORE AS PAYLOAD (TABLESPACE API_PEN_VALIDATION_BLOB_DATA);
...
LOB (SAGA_EVENT_RESPONSE) STORE AS SAGA_EVENT_RESPONSE (TABLESPACE API_PEN_VALIDATION_BLOB_DATA);
